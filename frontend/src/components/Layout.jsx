    ...
    <div className="min-h-screen text-[var(--text)] flex flex-col lg:flex-row overflow-x-hidden w-full bg-[var(--bg)]">
      ...
      <aside className="hidden lg:flex flex-col w-[260px] shrink-0 border-r border-[var(--border)] bg-[var(--surface)] min-h-screen px-4 py-6 z-40 fixed inset-y-0 left-0">
        <div className="flex flex-col mb-6 px-2">
          ...
          <div className="text-[13px] font-bold text-[var(--text-dim)] truncate pl-[38px]">
        ...
        {/* Account Bottom */}
        <div className="flex flex-col space-y-1.5 mt-6 pt-4 border-t border-[var(--border)]">
      ...
      <header className="lg:hidden h-16 flex items-center justify-between px-4 sm:px-6 w-full border-b border-[var(--border)] shrink-0">
        ...
        <div className="flex items-center gap-1.5">
          <SearchBox />
          <NavLink to="/settings" className="flex items-center justify-center h-9 w-9 shrink-0 rounded-full bg-[var(--field)] text-[var(--text-dim)] hover:text-[var(--text)] transition-colors border border-[var(--border)]">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>
          </NavLink>
          <button onClick={handleLogout} className="flex items-center justify-center h-9 w-9 shrink-0 rounded-full bg-[var(--field)] text-[var(--text-dim)] hover:text-[var(--text)] transition-colors border border-[var(--border)]">
